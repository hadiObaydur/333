...
public class ListSourceAdapterForItemList extends RecyclerView.Adapter<ListSourceAdapterForItemList.ListSourceViewHolder>{
    ...
    public ListSourceAdapterForItemList(Context context, ArrayList<String> webSite,int count) {
    ...
    public ListSourceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.eachcategoryview,parent,false);
